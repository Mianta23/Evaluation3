    ...
    <div class="d-flex flex-column" id="content-wrapper">
      <div id="content">
        ...
        <div class="container-fluid">
            <form action="{{ url('/ajouterpatient') }}" method="POST">
              {{ csrf_field() }}
            ...
            <div class="mb-3">
              ...
              <input type="date" name="datenaissance" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
        ...
        <<div class="mb-3">
            <label for="" class="form-label">Remboursement:</label>
            <select name="remboursement" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
