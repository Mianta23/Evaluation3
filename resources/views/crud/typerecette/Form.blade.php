        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="{{ url('/ajoutertyperecette') }}" method="POST">
                        {{ csrf_field() }}
                ...
                <div class="mb-3">
                    <label for="" class="form-label">Type de la date:</label>
                    <input type="text" name="typedate" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Budget:</label>
                    <input type="text" name="budget" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp">
                </div>
