...
@endif
        <br>
        <a class="btn btn-primary" href="{{ url('/formtyperecette') }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Ajouter typerecette</a>
        <br>
            <div class="table-responsive">
                <table class="table text-nowrap mb-0 align-middle">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{ $rows->idtyperecette }}</h6></td>
                      ...
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/versmodiftyperecette') }}/{{ $rows->idtyperecette }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Modifier</a>
                      </td>
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/supprimertyperecette') }}/{{ $rows->idtyperecette }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Supprimer</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
  ...
  <a class="page-link" href="{{ $currentPage == 1 ? '#' : url('/paginationtyperecette') }}/{{ $currentPage - 1 }}" aria-label="Précédent">
  ...
  <a class="page-link" href="{{ url('/paginationtyperecette') }}/{{ $rows }}">{{ $rows }}</a>
  </li>
  @endforeach
  <li class="page-item {{ $currentPage == $lastPage ? 'disabled' : '' }}">
  <a class="page-link" href="{{ $currentPage == $lastPage ? '#' : url('/paginationtyperecette') }}/{{ $currentPage + 1 }}" aria-label="Suivant">
