...
@endif
        <br>
        <a class="btn btn-primary" href="{{ url('/formdepense') }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Ajouter depense</a>
        <br>
            ...
            <div class="table-responsive">
                <table class="table text-nowrap mb-0 align-middle">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{ $rows->iddepense }}</h6></td>
                      ...
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/versmodifdepense') }}/{{ $rows->iddepense }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Modifier</a>
                      </td>
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/supprimerdepense') }}/{{ $rows->iddepense }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Supprimer</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
  ...
  <a class="page-link" href="{{ $currentPage == 1 ? '#' : url('/paginationdepense') }}/{{ $currentPage - 1 }}" aria-label="Précédent">
  ...
  <a class="page-link" href="{{ url('/paginationdepense') }}/{{ $rows }}">{{ $rows }}</a>
  </li>
  @endforeach
  <li class="page-item {{ $currentPage == $lastPage ? 'disabled' : '' }}">
  <a class="page-link" href="{{ $currentPage == $lastPage ? '#' : url('/paginationdepense') }}/{{ $currentPage + 1 }}" aria-label="Suivant">
