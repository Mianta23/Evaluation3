...
@endif
        <br>
        <a class="btn btn-primary" href="{{ url('/formtypedepense') }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Ajouter typedepense</a>
        <br>
                ...
                <table class="table text-nowrap mb-0 align-middle">
                  <thead class="text-dark fs-4">
                    <tr>
                      ...
                      <th class="border-bottom-0">
                        <h6 class="fw-semibold mb-0">Nom du type</h6>
                      </th>
                      <th class="border-bottom-0">
                        <h6 class="fw-semibold mb-0">Type de la date</h6>
                      </th>
                      <th class="border-bottom-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{ $rows->idtypedepense }}</h6></td>
                      ...
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/versmodiftypedepense') }}/{{ $rows->idtypedepense }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Modifier</a>
                      </td>
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/supprimertypedepense') }}/{{ $rows->idtypedepense }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Supprimer</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
  ...
  <a class="page-link" href="{{ $currentPage == 1 ? '#' : url('/paginationtypedepense') }}/{{ $currentPage - 1 }}" aria-label="Précédent">
  ...
  <a class="page-link" href="{{ url('/paginationtypedepense') }}/{{ $rows }}">{{ $rows }}</a>
  </li>
  @endforeach
  <li class="page-item {{ $currentPage == $lastPage ? 'disabled' : '' }}">
  <a class="page-link" href="{{ $currentPage == $lastPage ? '#' : url('/paginationtypedepense') }}/{{ $currentPage + 1 }}" aria-label="Suivant">
