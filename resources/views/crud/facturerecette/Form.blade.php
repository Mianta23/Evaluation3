    ...
    <div class="d-flex flex-column" id="content-wrapper">
      <div id="content">
        ...
        <div class="container-fluid">
            <form action="{{ url('/ajouterfacturerecette') }}" method="POST">
              {{ csrf_field() }}
            ...
            <div class="mb-3">
              <label for="" class="form-label">Date Facture:</label>
              <input type="date" name="datefacturerecette" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
