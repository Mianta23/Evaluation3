...
@endif
        <br>
        <a class="btn btn-primary" href="{{ url('/formfacturerecette') }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Ajouter facture recette</a>
        <br>
                ...
                <table class="table text-nowrap mb-0 align-middle">
                  <thead class="text-dark fs-4">
                    <tr>
                      ...
                      <th class="border-bottom-0">
                        <h6 class="fw-semibold mb-0">Nom du patient</h6>
                      </th>
                      <th class="border-bottom-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="border-bottom-0"><h6 class="fw-semibold mb-0">{{ $rows->idfacturerecette}}</h6></td>
                      ...
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/versmodiffacturerecette') }}/{{ $rows->idfacturerecette }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Modifier</a>
                      </td>
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/supprimerfacturerecette') }}/{{ $rows->idfacturerecette }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">Supprimer</a>
                      </td>
                      <td class="border-bottom-0">
                        <a class="btn btn-primary" href="{{ url('/pdf') }}/{{ $rows->idfacturerecette }}" style="background: var(--bs-blue);border-style: none;margin-top: 5px;">PDF</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
  ...
  <a class="page-link" href="{{ $currentPage == 1 ? '#' : url('/paginationfacturerecette') }}/{{ $currentPage - 1 }}" aria-label="Précédent">
  ...
  <a class="page-link" href="{{ url('/paginationfacturerecette') }}/{{ $rows }}">{{ $rows }}</a>
  </li>
  @endforeach
  <li class="page-item {{ $currentPage == $lastPage ? 'disabled' : '' }}">
  <a class="page-link" href="{{ $currentPage == $lastPage ? '#' : url('/paginationfacturerecette') }}/{{ $currentPage + 1 }}" aria-label="Suivant">
