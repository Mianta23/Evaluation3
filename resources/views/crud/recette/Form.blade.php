        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="{{ url('/ajouterrecette') }}" method="POST">
                        {{ csrf_field() }}
                ...
                <input type="hidden" id="imageCode"  name="photo"/>
                        ...
                        {{-- </div> --}}
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label"> Acte:</label>
                            <div class="col-sm-10">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Id Facture:</label>
                            <div class="col-sm-10">
                                <select name="idfacturerecette" class="form-select" aria-label="Default select example">
                                    <option value="">Numero facture:</option>
                                    @foreach ($dataa as $dataa)
                                        <option value="{{ $dataa->idfacturerecette }}">{{ $dataa->idfacturerecette }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
