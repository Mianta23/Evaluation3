<nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--bs-blue);">
  ...
  <li class="nav-item"><a class="nav-link" href="{{ url('/listePatient') }}"><i class="fas fa-book-reader"></i><span>Gestion patient&nbsp;</span></a></li>
    <li class="nav-item"><a class="nav-link" href="{{ url('/listeTyperecette') }}"><i class="fas fa-book-reader"></i><span>Gestion Typerecette&nbsp;</span></a></li>
      ...
      <li class="nav-item"><a class="nav-link" href="{{ url('/listeStatistique') }}"><i class="fas fa-chart-line"></i><span>Tableau de bord&nbsp;</span></a></li>
