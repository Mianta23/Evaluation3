    ...
    <div style="height: 100vh;" class="container-fluid d-flex justify-content-center align-items-center login-view">
        <div class="row col-md-6">
            ...
            <div class="col-md-6 border rounded p-3 shadow login-form mx-auto">
                <form action="{{ url('/frontlogin') }}" method="post" class="mb-2">
                    @csrf
                    <div class="row justify-content-center mb-2 mt-3">
                        <h2>Bienvenue Utilisateur! Connectez-vous</h2>
                    </div>
                    <div class="form-group form-comp">
                        ...
                        @enderror
                        <input type="text" name="email" value="utilisateur@gmail.com" id="email" class="form-control" placeholder="Email">
                    </div>
                    <div class="form-group form-comp">
                        @error('password')
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        @enderror
                        <input type="password" name="mdp" value="utilisateur" id="password" class="form-control"
                            placeholder="Mot de passe">
                    </div>
                    <div class="form-group form-comp">
                        <button class="btn btn-primary w-70 " type="submit">Valider</button>
                    </div>
                    <hr>
                </form>
            </div>
