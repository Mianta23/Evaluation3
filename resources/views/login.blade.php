            ...
            <div class="col-md-6 border rounded p-3 shadow login-form mx-auto">
                <form action="{{ url('/log_admin') }}" method="post" class="mb-2">
                    ...
                    <div class="row justify-content-center mb-2 mt-3">
                        <h2>Bienvenue Administrateur! Connectez-vous</h2>
                    </div>
                    <div class="form-group form-comp">
                        ...
                        @enderror
                        <input type="text" name="email" value="admin@gmail.com" id="email" class="form-control" placeholder="Email">
                    </div>
                    <div class="form-group form-comp">
                        @error('password')
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        @enderror
                        <input type="password" name="mdp" value="admin" id="password" class="form-control"
